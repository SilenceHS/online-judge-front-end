      ...
      <Cell :xs="25" :sm="25" :md="25" :lg="25" :xl="25">
        <div class="h-panel" ref="panel">
          <div class="h-panel-bar">
            ...
            <textarea v-model="description" style="width:100%" rows=10 v-autosize placeholder="请输入题目描述"></textarea>
            ...
            <textarea v-model="sampleinput" style="width:100%" rows=10 v-autosize placeholder="请输入输入样例,例如:5"></textarea>
            <div style="font-size: 180%;line-height: 2.5em;">输出样例</div>
            <textarea v-model="sampleoutput" style="width:100%" rows=10 v-autosize placeholder="请输入输入样例,例如:25"></textarea>
...
export default {
  data() {
    ...
    levelCheck:['简单','普通','困难'],
      ...
      result: "",
      accepted: false,
      placeholder:"测试用例格式如下,以--InEnd--和--OutEnd--来标识,例如:\n1\n2\n3\n--InEnd--\n6\n--OutEnd--\n2\n3\n4\n--InEnd--\n8\n--OutEnd--"
    };
  },
  methods: {
    setSize() {
    ...
    submit() {
      ...
      this.sampleinput!=null&&this.sampleinput!=""&&
      this.sampleoutput!=null&&this.sampleoutput!=""&&
      this.timelimit!=null&&this.timelimit!=""&&
     this. memorylimit!=null&&this.memorylimit!=""&&
      this.testcase!=null&&this.testcase!=""){
        this.$http
        .post(
          "http://" + this.Parms.host + this.Parms.port + "/api/addquiz/",
          {
            name: this.name,
