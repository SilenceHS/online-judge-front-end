    ...
    <div class="login-container">
      <div class="login-content">
        ...
        <div class="login-name login-input">
          ...
          <span class="placeholder" :class="{fixed: login.username != '' && login.username != null}">用户名或邮箱</span>
        </div>
        ...
        <div class="buttonDiv">
          <Button :loading="loading" block color="primary" size="l" @click="test">登录</Button>
        </div>
        <div class="regiser">
          <div>没有账号？</div>
